								...
								<Row>
									...
									<Col size={'md-8'}>
										...
										<p className="card-text">
											This will remove {name !== '' ? name : 'this family member'} from your list.
										</p>
									</Col>
								</Row>
							</div>
						...
						<div className="card box-shadow mt-5">
							<div className="card-body text-center">
								<Row>
									<Col size={'md-2'} />
									<Col size={'md-8'}>
										<h2 className="card-title">Remove {name === '' ? 'this family member' : name}</h2>
										<p className="card-text">
											Delete {name !== '' ? name : 'this family member'} from your record list?
										</p>
									</Col>
									<Col size={'md-2'}>
